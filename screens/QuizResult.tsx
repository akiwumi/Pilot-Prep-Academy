...
export const QuizResult: React.FC<Props> = ({ onNavigate }) => {
  return (
    <div className="bg-background font-display text-white min-h-screen flex flex-col antialiased selection:bg-primary selection:text-white">
        ...
        <div className="sticky top-0 z-50 flex items-center bg-background p-4 pb-2 justify-between border-b border-gray-800/50">
            <div onClick={() => onNavigate(Screen.CourseOverview)} className="flex size-12 shrink-0 items-center justify-start text-white cursor-pointer hover:opacity-70 transition-opacity">
        ...
        <main className="flex-1 flex flex-col items-center w-full px-4 pb-32 z-10">
            <div className="w-full flex flex-col items-center pt-8 pb-6">
                <h2 className="text-gray-400 tracking-wide text-sm font-medium uppercase mb-6">Quiz Complete</h2>
            ...
            <button className="w-full max-w-md flex items-center justify-between p-4 rounded-2xl bg-surface border border-gray-800 hover:bg-gray-800/50 transition-colors group shadow-sm mb-4">
